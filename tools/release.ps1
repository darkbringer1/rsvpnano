#!/usr/bin/env pwsh
# Usage: .\tools\release.ps1 v0.1.0-amoled [--branch amoled-port]
...
if ($Version -notmatch '^v\d+\.\d+\.\d+') {
    Write-Error "Version must start with 'v' followed by semver, e.g. v0.1.0-amoled"
    exit 1
}
...
Write-Host "Monitor the build at: https://github.com/darkbringer1/rsvpnano/actions" -ForegroundColor Cyan
